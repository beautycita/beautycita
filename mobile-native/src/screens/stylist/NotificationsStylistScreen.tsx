...
type Props = NativeStackScreenProps<any, 'NotificationsStylistScreen'>;

export const NotificationsStylistScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>View all notifications</Text>
...
export default NotificationsStylistScreen;
