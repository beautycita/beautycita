...
type Props = NativeStackScreenProps<any, 'AddPortfolioPhotoScreen'>;

export const AddPortfolioPhotoScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Upload portfolio photo</Text>
...
export default AddPortfolioPhotoScreen;
