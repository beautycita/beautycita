...
type Props = NativeStackScreenProps<any, 'StripeConnectSetupScreen'>;

export const StripeConnectSetupScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>Stripe Setup</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Connect your Stripe account</Text>
...
export default StripeConnectSetupScreen;
