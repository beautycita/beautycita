...
type Props = NativeStackScreenProps<any, 'MyPortfolioScreen'>;

export const MyPortfolioScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Manage portfolio photos</Text>
