...
type Props = NativeStackScreenProps<any, 'BlockDatesScreen'>;

export const BlockDatesScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>Block Dates</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Block specific dates for vacation or personal time</Text>
