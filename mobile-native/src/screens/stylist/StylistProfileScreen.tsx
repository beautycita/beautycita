...
type Props = NativeStackScreenProps<any, 'StylistProfileScreen'>;

export const StylistProfileScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Preview your public profile</Text>
