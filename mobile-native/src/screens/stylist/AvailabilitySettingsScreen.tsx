...
type Props = NativeStackScreenProps<any, 'AvailabilitySettingsScreen'>;

export const AvailabilitySettingsScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>Availability Settings</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Manage your weekly hours and blocked dates</Text>
