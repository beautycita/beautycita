...
type Props = NativeStackScreenProps<any, 'SetWeeklyHoursScreen'>;

export const SetWeeklyHoursScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>Set Weekly Hours</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Configure recurring weekly schedule</Text>
...
export default SetWeeklyHoursScreen;
