...
type Props = NativeStackScreenProps<any, 'ClientDetailScreen'>;

export const ClientDetailScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>Client Detail</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>View client information</Text>
