...
type Props = NativeStackScreenProps<any, 'EditStylistProfileScreen'>;

export const EditStylistProfileScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Update your stylist information</Text>
...
export default EditStylistProfileScreen;
