...
type Props = NativeStackScreenProps<any, 'SettingsStylistScreen'>;

export const SettingsStylistScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>App and account settings</Text>
...
export default SettingsStylistScreen;
