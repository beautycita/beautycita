...
type Props = NativeStackScreenProps<any, 'MyReviewsStylistScreen'>;

export const MyReviewsStylistScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>My Reviews</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Reviews from clients</Text>
...
export default MyReviewsStylistScreen;
