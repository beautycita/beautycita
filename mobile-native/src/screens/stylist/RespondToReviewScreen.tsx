...
type Props = NativeStackScreenProps<any, 'RespondToReviewScreen'>;

export const RespondToReviewScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: textColor }]}>Respond to Review</Text>
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>Reply to client review</Text>
...
export default RespondToReviewScreen;
