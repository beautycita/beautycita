...
type Props = NativeStackScreenProps<any, 'StripeDashboardScreen'>;

export const StripeDashboardScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={[styles.container, { backgroundColor }]}>
      <View style={styles.content}>
        ...
        <GradientCard padding="large" darkMode={darkMode} style={styles.card}>
          <Text style={[styles.description, { color: textSecondary }]}>View Stripe account status</Text>
...
export default StripeDashboardScreen;
