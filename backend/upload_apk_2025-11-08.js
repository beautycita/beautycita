...
async function uploadAPK() {
  const version = '2.4.0-onboarding-fixes';
  const timestamp = '2025-11-08';

  console.log(`🚀 Uploading BeautyCita v${version} APK to Cloudflare R2...`);
  console.log(`Bucket: ${BUCKET_NAME}\n`);

  const result = await uploadFile(
    '/var/www/beautycita.com/frontend/android/app/build/outputs/apk/release/app-release.apk',
    'downloads/mobile/BeautyCita-v2.4.0.apk',
