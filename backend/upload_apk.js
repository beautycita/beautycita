...
async function uploadAPK() {
  console.log('Uploading BeautyCita v1.2.4 to Cloudflare R2...');
  console.log(`Bucket: ${BUCKET_NAME}\n`);

  const result = await uploadFile(
    '/var/www/beautycita.com/BeautyCita-v1.2.4-arm64.apk',
    'downloads/mobile-native/BeautyCita-v1.2.4.apk',
