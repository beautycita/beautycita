...
async function uploadAPK() {
  console.log('🚀 Uploading BeautyCita v2.3.0-final APK to Cloudflare R2...');
  console.log(`Bucket: ${BUCKET_NAME}\n`);

  const result = await uploadFile(
    '/var/www/beautycita.com/beautycita-mobile-v2.3.0-final.apk',
    'downloads/mobile/BeautyCita-v2.3.0.apk',
