  ...
  const downloadCategories = [
    {
      ...
      items: [
        {
          name: 'BeautyCita Web App (v2.4.0) ⭐ LATEST',
          description: 'Capacitor PWA - Fixed onboarding forms & responsive design',
          size: '120.2 MB',
          url: `${R2_PUBLIC_URL}/downloads/mobile/BeautyCita-v2.4.0.apk`,
          format: 'APK',
          contents: [
            '🔧 CRITICAL FIX: Client onboarding form completely overhauled',
            '✅ Removed translation keys - pure English text throughout',
            '✅ Mobile-first responsive design (fits all screen sizes)',
            '✅ Fixed modal alignment issues on mobile devices',
            '✅ Responsive padding and sizing (base/sm/md breakpoints)',
            '📱 No horizontal scrolling - perfect containment',
            '✅ All Playwright E2E tests passing (4/4)',
            '⚡ Ultra-lightweight - 96% smaller than native builds',
            '📱 Videos & media loaded from Cloudflare R2 CDN',
            '🚫 No pinch zoom - native app experience',
            '🚫 No pull-to-refresh - optimized UX',
            '🎨 Removes footer/navbar in mobile context',
            '🔐 Biometric authentication (fingerprint/face)',
            '📍 Google Maps integration',
            '💳 Secure Stripe payment processing',
            '🔔 Push notifications & real-time updates',
            '📅 Advanced booking calendar with Syncfusion',
            'Built with React 18 + Vite + TypeScript + Capacitor'
          ]
        },
        {
          name: 'BeautyCita Web App (v2.3.0)',
          description: 'Capacitor PWA - Fixed translation JSON structure',
          size: '4.4 MB',
          url: `${R2_PUBLIC_URL}/downloads/mobile/BeautyCita-v2.3.0.apk`,
          format: 'APK',
          contents: [
            '🔧 CRITICAL FIX: Moved clientOnboarding to root level in JSON',
            '✅ All onboarding forms now display proper translations',
            '✅ Fixed translation keys showing instead of text',
            '✅ AuthModal fully internationalized',
            '✅ UnifiedAuthPage namespace corrected',
        ...
        {
          name: 'Android Native App (v1.2.9)',
          description: 'React Native - Zero upfront permissions + phone verification working',
          size: '29 MB',
          url: `${R2_PUBLIC_URL}/apps/beautycita.apk`,
          format: 'APK',
          contents: [
            '✅ NO permissions requested upfront - fully lazy loaded',
            '📱 Location only requested when starting booking process',
            '📷 Camera only requested when taking photos',
            '📁 Storage only requested when uploading files',
            '🔔 Notifications only requested when needed',
            '📞 Phone verification working - SMS code sent after registration',
            '🎨 Custom BC-styled gradient alerts throughout app',
            '🎥 Video fills screen top-to-bottom (portrait + landscape)',
            '🔐 Registration fixed with proper data handling',
            '📍 Real-time location tracking on booking confirmation',
            '🗺️ Animated map: zoom 3 (stylist) → zoom 15 (client location)',
            '🚗 Turn-by-turn directions with Google Maps integration',
            '⏰ 30-minute background tracking after app closes',
            '📡 Automatic proximity alerts (10min, 5min, arrived)',
            'Complete navigation - 81 screens',
            'Built with React Native 0.82.1 (TypeScript)',
            'Native Stripe payments (Apple Pay, Google Pay)',
            'Push notifications via OneSignal'
          ],
          releaseNotes: '/downloads/mobile-native/RELEASE_NOTES_v1.2.9.md'
        },
        {
