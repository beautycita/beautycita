              ...
              <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-beauty-soft border border-white/30">
                ...
                <div className="text-center mb-6 relative">
                  ...
                  <motion.div
                    ...
                    className="w-20 h-20 mx-auto mb-4 bg-gradient-rose-gold rounded-3xl flex items-center justify-center shadow-rose-gold-glow"
                  >
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-beauty-blush to-beauty-coral rounded-3xl flex items-center justify-center">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-beauty-lavender to-beauty-lilac rounded-3xl flex items-center justify-center">
                      <span className="text-white text-xs">📍</span>
                    </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-beauty-mint to-beauty-lime-green rounded-3xl flex items-center justify-center">
                      <span className="text-white text-xs">💖</span>
                    </div>
                ...
                >
                  <button
                    onClick={onAllow}
                    className="w-full py-4 bg-gradient-rose-gold text-white font-semibold rounded-3xl hover:shadow-rose-gold-glow transition-all duration-300 transform hover:scale-105"
                  >
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={onDeny}
                      className="flex-1 py-3 text-gray-600 font-medium rounded-3xl hover:bg-gray-100 transition-colors"
                    >
                      Not Now
                    </button>
                    ...
                    {onDontAskAgain && (
                      <button
                        ...
                        className="flex-1 py-3 text-gray-500 text-sm font-medium rounded-3xl hover:bg-gray-50 transition-colors"
                      >
                        Don't Ask Again
                      </button>
                    )}
