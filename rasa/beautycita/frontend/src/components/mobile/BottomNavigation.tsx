          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.div
                  layoutId="bottomNav"
                  className="absolute -top-0.5 left-1/2 transform -translate-x-1/2 w-8 h-1 bg-gradient-tiktok rounded-full"
                  initial={false}
                  transition={{
                    type: "spring",
                    stiffness: 500,
              ...
              <motion.div
                initial={{ scale: 0 }}
                whileTap={{ scale: 1 }}
                className="absolute inset-0 bg-beauty-cyber/10 rounded-lg pointer-events-none"
              />
            </Link>
          )
        })}
